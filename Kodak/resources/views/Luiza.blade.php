...
<html lang="en">
  <head>
    ...
    <link type="image/png" sizes="16x16" rel="icon" href="/favicon1-16x16.png">
    <link type="image/png" sizes="32x32" rel="icon" href="/favicon1-32x32.png">
    <link type="image/png" sizes="96x96" rel="icon" href="/favicon1-96x96.png">
    <link type="image/png" sizes="120x120" rel="icon" href="/favicon1-120x120.png">
    <link type="image/png" sizes="192x192" rel="icon" href="/favicon1-192x192.png">
    <title>Открыточка Луизочке</title>
  </head>
  <body>
...
<main class="scene">
    ...
    <i class="heart-exclaim" aria-hidden="true">Дадла)</i>
  </main>
