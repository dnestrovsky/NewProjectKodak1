...
<main>
    ...
    <section class="container main-image-container mt-2" >
        <ul class="menu">
            <li title="Авторизация"><a href="/login" class="login">Авторизация</a></li>
            <li title="Заказать"><a href="/orders" class="archive">Заказать</a></li>
            <li title="Связь"><a href="/contact" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="contact">Связь</a></li>
        </ul>
            @yield('content')
    </section>
