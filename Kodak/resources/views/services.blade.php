        ...
        <div class="inner-width">
            ...
            <div class="about-content">
                ...
                <div class="about-text">
                    ...
                    <p>
                        В нашем магазине Вы можете сделать фото любого размера. Фото будет распечатано на профессиональной фотобумаге.
        ...
        <div class="inner-width">
            ...
            <div class="about-content">
                ...
                <div class="about-text">
                    ...
                    <p>
                        В нашем магазине Вы можете сделать печать на холсте. Можно предложить и индивидуальный размер.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section id="album">
        <div class="inner-width">
            ...
            <div class="about-content">
                ...
                <div class="about-text">
                    <p>
                        В нашем магазине вы можете подобрать и приобрести различные аксессуары для фотографий их хранения. У нас огромный выбор фоторамок, фотоальбомов, карт памяти любого объёма памяти!
                    </p>
                </div>
            </div>
        </div>
