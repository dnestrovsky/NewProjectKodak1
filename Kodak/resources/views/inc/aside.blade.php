<div class="sidebar" data-image="../resources/img/sidebar-5.jpg" data-color="black">
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="/" class="simple-text">
                        <img src="img/palitra.jpg"  class="rounded" style="width: 230px; height: 80px;" alt="...">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/souvenirs-all">
                    ...
                    <li>
                        <a class="nav-link" data-toggle="collapse" data-target="#navbarHeader" aria-controls="navbarHeader" aria-expanded="false" aria-label="Toggle navigation" href="#">
        ...
        <div class="sidebar-background" style="background-image: url(../img/photo.jpg) "></div></div>
